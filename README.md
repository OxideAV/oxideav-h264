...
field POCs) — four PAFF fixtures (I fields, P field pairs,
cross-parity reference, mixed frame/field switching) gate BitExact,
...
holds 35 fixtures and **all 35 targets gate `BitExact` over their full

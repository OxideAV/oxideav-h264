...
const TBL_9_30: &[(usize, InitCell)] = &[
    ...
    (805, InitCell::all((-12, 104), (10, 41), (-7, 69), (1, 67))),
    ...
    (849, InitCell::all((-12, 104), (10, 41), (-7, 69), (1, 67))),
...
const TBL_9_32: &[(usize, InitCell)] = &[
    ...
    (975, InitCell::all((-6, 62), (1, 38), (-10, 57), (-8, 66))),
    (976, InitCell::all((-4, 65), (2, 43), (-9, 58), (-7, 70))),
    (
        977,
        InitCell::all((-12, 73), (-6, 55), (-16, 72), (-14, 75)),
    ),
    (978, InitCell::all((-8, 76), (0, 58), (-7, 69), (-10, 79))),
    (979, InitCell::all((-7, 80), (0, 64), (-4, 69), (-9, 83))),
    (980, InitCell::all((-9, 88), (-3, 74), (-5, 74), (-12, 92))),
    (
        981,
        InitCell::all((-17, 110), (-10, 90), (-9, 86), (-18, 108)),
    ),
    ...
    (1005, InitCell::all((-6, 62), (1, 38), (-10, 57), (-8, 66))),
    (1006, InitCell::all((-4, 65), (2, 43), (-9, 58), (-7, 70))),
    (
        1007,
        InitCell::all((-12, 73), (-6, 55), (-16, 72), (-14, 75)),
    ),
    (1008, InitCell::all((-8, 76), (0, 58), (-7, 69), (-10, 79))),
    (1009, InitCell::all((-7, 80), (0, 64), (-4, 69), (-9, 83))),
    (1010, InitCell::all((-9, 88), (-3, 74), (-5, 74), (-12, 92))),
    (
        1011,
        InitCell::all((-17, 110), (-10, 90), (-9, 86), (-18, 108)),
    ),
...
pub fn decode_coeff_abs_level_minus1(
    ...
    // §7.4.5.3.2 / §7.4.5.3.3 bound the absolute coefficient at
    // 2^(7 + BitDepth): 32 768 for 8-bit streams, 2^21 at 14-bit
    // (round-456: the old cap of 14 leading ones — a worst-case `val`
    // of ≈ 49 K — rejected legal 12-/14-bit residuals; a value of
    // 2^21 needs k = 20). Cap `k` at 20 — worst-case `val` ≈ 14 +
    // 2^22, still small enough that the downstream `c * ls` in the
    // §8.5.12 inverse-quant arithmetic (LevelScale ≤ 25 · 16) stays
    // within i32. Streams that ask for 21+ leading-one bins are
    // malformed at every bit depth.
    let mut k: u32 = 0;
    let mut suf_s: u32 = 0;
    loop {
        let b = dec.decode_bypass()? as u32;
